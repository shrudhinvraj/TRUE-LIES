...
print(DataPrep.train_ad['Statement'].values)
train_count = countV.fit_transform(DataPrep.train_ad['Statement'].values)
print(countV)
print(train_count)
...
training_sentences = DataPrep.train_ad['Statement']
